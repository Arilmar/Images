		...
		<div style="width: 100%">
				...
				<table>
					...
					<tr>
						<td><input readonly="readonly" type="text"
							style="width: 80px;" id="id" name="id"
					...
					<tr>
						<td><input type="text" style="width: 200px;" id="produto"
					...
					<tr>
						<td><select style="width: 200px;" id="fornecedor"
							name="fornecedor">
			...
			if (imagem != null && imagem.getFornecedor().equalsIgnoreCase("Fonecedor A")) {
				...
				out.print("selected=\"selected\"");
					...
					<tr>
						<td><select style="width: 200px;" id="tamanhomini"
							name="tamanhomini">
				...
				<br /> <br /> <br /> <br /> <input type="submit"
					onclick="document.getElementById('formImagem').action = 'controllerImagem?acao=salvar'"
					value="Salvar"> <input type="submit"
					onclick="document.getElementById('formImagem').action = 'controllerImagem?acao=deletar&id=${imagem.id}'"
					value="Excluir"> <input type="submit"
					onclick="document.getElementById('formImagem').action = 'controllerImagem?acao=todos'"
					value="Todos">
			</div>
			...
			<br /> <input type="button" value="Excluir imagem"
				onclick="deletaFoto();"> <input onchange="visualizarImg();"
				type="file" value="Selecionar a imagem">
	...
	<form method="get" action="controllerImagem">
		<div align="left" style="width: 100%;">
			<table align="left" style="widows: 100%">
				<tr>
					<td style="width: 70px;" align="left"><u><b>Código</b></u></td>
					<td style="width: 70px;" align="left"><u><b>Imagem</b></u></td>
					<td style="width: 200px" align="left"><u><b>Produto</b></u></td>
					<td style="width: 200px" align="left"><u><b>Fornecedor</b></u></td>
				</tr>
				<c:forEach items='${listadeimagens}' var='imagem' varStatus="row">
					<c:choose>
					...
					<tr class="${estiloLinha}">
						<td style="width: 70px;" align="left"><c:out
								value="${imagem.id}" /></td>
						<td align="left"><img border="0" width="100" height="100"
							alt="Imagem" src="<c:out value="${imagem.urlminiimg}" />">
						</td>
						<td style="width: 200px" align="left"><c:out
								value="${imagem.produto}" /></td>
						<td style="width: 200px" align="left"><c:out
								value="${imagem.fornecedor}" /></td>
